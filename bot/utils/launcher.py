...
from bot.core.query import run_query_tapper, run_query_tapper1, run_multiple_tappers
...
async def process() -> None:
    ...
    if action == 2:
        ...
        if ans == "y":
            ...
            session_names = [i for i in range(len(query_ids) + 10)]
            await run_multiple_tappers(query_ids, session_names, proxies)
        else:
            with open("data.txt", "r") as f:
                query_ids = [line.strip() for line in f.readlines()]
            proxies = get_proxies()
